  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Form container ── */}
        <div className="relative w-full max-w-[400px] pt-14 lg:pt-0 max-h-[90vh] overflow-y-auto">
          {/* Heading */}
          <h1
            className="
              font-[family-name:var(--font-cormorant)]
          ...
          >
            {(['email', 'phone'] as RegisterMethod[]).map((m) => (
              <button
                ...
                style={{
                  backgroundColor: registerMethod === m ? theme.primary.background : 'transparent',
                  color:
                    registerMethod === m ? theme.primary.foreground : theme.secondary.foreground,
                  boxShadow:
                    registerMethod === m ? `0_5px_18px_${theme.primary.background}48` : 'none',
                }}
              >
          ...
          <form noValidate onSubmit={service.mutate.onRegister} className="space-y-5">
            {/* ── Full Name ── */}
            <div>
              <Label
              ...
              <div
                ...
                style={{
                  borderBottomColor:
                    focusedField === 'fullname' ? theme.primary.background : theme.border,
                }}
              >
                <svg
                  viewBox="0 0 16 16"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    state.setFormRegister((prev) => ({ ...prev, fullname: e.target.value }))
                  }
            ...
            <div>
              ...
              <div
                ...
                style={{
                  borderBottomColor:
                    focusedField === 'idenfier' ? theme.primary.background : theme.border,
                }}
              >
                ...
                <Input
                  ...
                  placeholder={
                    registerMethod === 'email' ? 'name@email.com' : '+62 81 - 2345 - 6789'
                  }
                  value={state.formRegister.idenfier}
                  onChange={(e) =>
                    state.setFormRegister((prev) => ({ ...prev, idenfier: e.target.value }))
                  }
                  onFocus={() => setFocusedField('idenfier')}
                  onBlur={() => setFocusedField(null)}
                  className="flex-1 bg-transparent border-none outline-none text-[14px] placeholder:text-gray-400 placeholder:opacity-100"
                  style={{ color: theme.foreground }}
                />
            ...
            <div>
              ...
              >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    state.setFormRegister((prev) => ({ ...prev, password: e.target.value }))
                  }
          ...
          {/* Footer mark */}
          <div className="flex items-center gap-[7px] opacity-20 mt-8">
